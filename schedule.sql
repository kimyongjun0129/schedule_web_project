...
(
    scheduledId BIGINT AUTO_INCREMENT PRIMARY KEY COMMENT '일정 ID',
    userId      BIGINT NOT NULL COMMENT '사용자 ID',
    toDoContent VARCHAR(100) NOT NULL COMMENT '할일',
    createAt    DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT '작성일',
    updateAt    DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP NOT NULL COMMENT '수정일',
